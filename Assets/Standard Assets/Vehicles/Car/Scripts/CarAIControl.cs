...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAIControl : MonoBehaviour
    {
        public enum BrakeCondition
        {
            ...
            ConditionalBrake,            // break if tracker has tag BreakSection
        ...
        [SerializeField] private float m_CautiousAngularVelocityFactor = 60f;                     // how cautious the AI should be when considering its own current angular velocity (i.e. easing off acceleration if spinning!)
        ...
        private void FixedUpdate()
        {
            ...
            else
            {
                ...
                switch (m_BrakeCondition)
                {
                    ...
                    case BrakeCondition.ConditionalBrake:
                        {
                            if (m_Target.tag.Contains("BrakeSection"))
                            {
                                if (m_Target.tag.Contains("Soft"))
                                {
                                    m_BrakeSensitivity = (Random.Range(5f, 14f)) / 100f;
                                }
                                else if (m_Target.tag.Contains("Medium"))
                                {
                                    m_BrakeSensitivity = (Random.Range(25f, 34f)) / 100f;
                                }
                                else if (m_Target.tag.Contains("Hard"))
                                {
                                    m_BrakeSensitivity = (Random.Range(45f, 54f)) / 100f;
                                }
                                else
                                {
                                    m_BrakeSensitivity = 0f;
                                }
